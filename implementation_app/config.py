...
DSR_MODEL_16 = APP_DIR / "weights" / "dsr" / "hybrid_dsr16.pth"
DSR_MODEL_24 = APP_DIR / "weights" / "dsr" / "hybrid_dsr24.pth"
DSR_MODEL_32 = APP_DIR / "weights" / "dsr" / "hybrid_dsr32.pth"

EDGEFACE_MODEL_16 = APP_DIR / "weights" / "facial_rec" / "edgeface_xxs.pt"
EDGEFACE_MODEL_24 = APP_DIR / "weights" / "facial_rec" / "edgeface_xxs.pt"
EDGEFACE_MODEL_32 = APP_DIR / "weights" / "facial_rec" / "edgeface_xxs.pt"
...
# get_dsr_config function has been removed as it is no longer used.
# Model configuration is now handled automatically by technical.dsr.load_dsr_model
